...
namespace CoffeeStore
{
    public partial class frmMain : Form
    {
        ...
        {
            mnuQuanLy.Enabled = type == 1;
            mnuThongTinTaiKhoan.Text += " (" + LoginAccount.DisplayName + ")";
        }
        ...
        {
            mnuThongTinTaiKhoan.Text = "Thông tin tài khoản (" + e.Acc.DisplayName + ")";
        }
        ...
        private void mnuChucNang_ThanhToan_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Hãy thử lại! Đã có lỗi! " + ex.Message.ToString(), "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        void btn_Click(object sender, EventArgs e)
        {
            ...
            mnuChucNang_ThanhToan.Enabled = true;
            mnuChucNang_ThemMon.Enabled = true;
        }
        ...
        private void XuatHoaDon(int idBill)
        {
            ...
            sql = "SELECT a.MaHD, a.NgayDat, a.Maban, b.TenNV, GiamGia, TongTien*(100-GiamGia)/100 as ThanhTien FROM HOADON AS a, Nhanvien AS b WHERE a.MaHD =" + idBill + "AND a.MaNV = b.MaNV";
        ...
        {
            timer1.Start();
            mnuChucNang.Enabled = false;
        }

        private void timer1_Tick(object sender, EventArgs e)
        {
            DateTime datetime = DateTime.Now;
            this.lblGio.Text = datetime.ToString(); 
        }
